...
| 7 | **in progress (2026-05-03)** | Minimal UI (`play/page.tsx`, Transcript, InputBox, VitalsBar). Death screen + restart. Playwright happy-path. **Author scenarios 1–5.** M1 milestone hit. |
