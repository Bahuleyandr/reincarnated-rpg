...
| 4 | **in progress (2026-05-03)** | Rules engine: `rules.ts` 2d6 + modifier + bands, seeded PRNG. Tool registry + Zod validators + atomicity wrapper. `sanitize.ts`. Eval harness skeleton. |
