  ...
  return (
    <main className="min-h-screen bg-stone-950 text-stone-200 font-mono px-6 py-10">
      <div className="max-w-3xl mx-auto space-y-5">
        ...
        {resolution && (
          <div className="text-xs text-stone-300 bg-amber-950/20 border border-amber-700/60 px-3 py-2 rounded">
        ...
        {folder === "challenge" && (
          <form onSubmit={challenge} className="space-y-3">
            <div>
              <label htmlFor="tgt" className="block text-xs text-stone-400 mb-1">
                target username
              </label>
              <input
                id="tgt"
