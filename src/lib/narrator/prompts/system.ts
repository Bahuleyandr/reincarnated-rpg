...
6. On a partial-success roll (7-9), you MUST pick exactly one move from the form's hard-move menu and call its tools.
7. On a miss roll (6-), the narrator makes a hard move. Tools called must reflect a real cost.
