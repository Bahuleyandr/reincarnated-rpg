...
export const letters = pgTable(
  ...
  {
    id: uuid("id").primaryKey(),
    /** Phase 10 P5: nullable so NPC senders can use
     *  fromNpcTemplateId. CHECK constraint letters_one_sender (in
     *  migration 0066) enforces at least one of the two sender
     *  columns. */
    fromUserId: uuid("from_user_id").references(() => users.id, {
      onDelete: "cascade",
    }),
    /** Phase 10 P5 — recurring NPC senders. When set, the letter
     *  was generated by the world (e.g. on first-meet) rather than
     *  composed by a player. */
    fromNpcTemplateId: text("from_npc_template_id"),
  ...
  (t) => [
    ...
    index("letters_from_npc_idx").on(t.fromNpcTemplateId, t.sentAt),
  ],
);
