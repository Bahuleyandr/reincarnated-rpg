...
const HUMAN_LABELS: Record<string, { label: string; description: string }> = {
  ...
  sense: { label: "sense", description: "read the room's pressure and motion" },
  act: { label: "test your shape", description: "learn one safe thing this body can do" },
  ...
  examine: { label: "examine", description: "study this place closely" },
